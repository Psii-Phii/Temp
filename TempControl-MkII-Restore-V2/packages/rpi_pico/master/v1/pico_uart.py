...
def get_serial_object():
    uart = UART(0) # opens UART on Pins Tx/Rx 1/2
    uart.init(9600, bits=8, parity=None, stop=1, timeout_char=1000, timeout=1000, rxbuf=256) # wait 1000ms between each incoming character
    return uart
